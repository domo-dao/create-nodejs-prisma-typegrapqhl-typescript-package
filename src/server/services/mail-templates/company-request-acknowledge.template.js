    ...
    <center>
      <div style="background: #fafafa; padding: 0px 15px 68px 15px;">
        ...
        >
          ...
          >
            Acknowledgment of Company Request
          </div>
          <div style="padding: 50px 120px;">
            <div style="max-width: 440px; line-height: 24px;">
              ...
              >
                Hello ${joinWaitingCompanyDetails.contactName}
                
              </div>
              <div
                style="font-size: 16px; margin-bottom: 24px; color: #838299;"
              >
                Thank you for showing interest in ${COMPANY_NAME}! One of our team members will contact you shortly.
              </div>
              <div
                style="font-size: 16px; margin-bottom: 24px; color: #838299;"
              >
