...
const debug = (0, import_debug.default)("prisma:cache-dir");
...
function getDownloadUrl(channel, version, platform, binaryName, extension = ".gz") {
  ...
  const finalExtension = platform === "windows" && import_download.BinaryType.libqueryEngine !== binaryName ? `.exe${extension}` : extension;
  if (binaryName === import_download.BinaryType.libqueryEngine) {
