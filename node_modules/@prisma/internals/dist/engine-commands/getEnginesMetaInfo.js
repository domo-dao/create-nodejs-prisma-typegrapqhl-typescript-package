...
async function getEnginesMetaInfo() {
  ...
  const engines = [
    ...
    },
    {
      ...
      type: import_fetch_engine.BinaryType.migrationEngine
    },
    {
      name: "introspection-engine",
      type: import_fetch_engine.BinaryType.introspectionEngine
    },
    {
      name: "format-binary",
      type: import_fetch_engine.BinaryType.prismaFmt
    }
  ];
