...
async function getConfigNodeAPI(options) {
  ...
  const pipeline = (0, import_function.pipe)(
    (0, import_queryEngineCommons.loadNodeAPILibrary)(queryEnginePath),
      ...
      E.map((errorOutputAsJSON) => {
        if (errorOutputAsJSON.is_panic) {
          const panic = new import_panic.RustPanic(
            ...
            errorOutputAsJSON.backtrace || e.error.stack || "NO_BACKTRACE",
            "query-engine-node-api get-config",
            import_panic.ErrorArea.QUERY_ENGINE_LIBRARY_CLI,
            options.prismaPath,
            void 0
          );
        ...
        return new GetConfigError({
          ...
          reason: (0, import_queryEngineCommons.createSchemaValidationError)(e.reason),
          errorCode
        });
      }),
  ...
  const error = (0, import_ts_pattern.match)(configEither.left).with({ type: "execa" }, (e) => {
    ...
    if ((0, import_panic.isExecaErrorCausedByRustPanic)(e.error)) {
      const panic = new import_panic.RustPanic(
        ...
        import_panic.ErrorArea.QUERY_ENGINE_BINARY_CLI,
        (_a = options.datamodelPath) != null ? _a : tempDatamodelPath,
        void 0
      );
