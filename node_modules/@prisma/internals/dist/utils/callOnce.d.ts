declare type AsyncFn<Args extends unknown[], R> = (...args: Args) => Promise<R>;
/**
 ...
 * @returns
 */
export declare function callOnce<Args extends unknown[], R>(fn: AsyncFn<Args, R>): AsyncFn<Args, R>;
export {};
