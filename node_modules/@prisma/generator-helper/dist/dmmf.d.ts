export declare namespace DMMF {
    ...
    type TypeRefScalar = TypeRefCommon & {
        location: 'scalar';
        type: string;
    };
    type TypeRefOutputObject = TypeRefCommon & {
        location: 'outputObjectTypes';
        type: OutputType | string;
    };
    type TypeRefEnum = TypeRefCommon & {
        location: 'enumTypes';
        type: SchemaEnum | string;
    };
    type OutputTypeRef = TypeRefScalar | TypeRefOutputObject | TypeRefEnum;
