...
import type { BatchTransactionOptions, EngineConfig, EngineEventType, GetConfigResult } from '../common/Engine';
...
export declare class BinaryEngine extends Engine {
     ...
     */
    constructor({ cwd, datamodelPath, prismaPath, generator, datasources, showColors, logLevel, logQueries, env, flags, clientVersion, previewFeatures, engineEndpoint, enableDebugLogs, allowTriggerPanic, dirname, activeProvider, tracingConfig, }: EngineConfig);
    private setError;
    ...
    requestBatch<T>(queries: string[], headers?: QueryEngineRequestHeaders, transaction?: BatchTransactionOptions, numTry?: number): Promise<QueryEngineResult<T>[]>;
    /**
     ...
     */
    transaction(action: 'start', headers: Tx.TransactionHeaders, options?: Tx.Options): Promise<Tx.Info>;
    transaction(action: 'commit', headers: Tx.TransactionHeaders, info: Tx.Info): Promise<undefined>;
    transaction(action: 'rollback', headers: Tx.TransactionHeaders, info: Tx.Info): Promise<undefined>;
