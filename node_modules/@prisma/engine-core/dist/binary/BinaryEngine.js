  ...
  setError(err) {
    ...
    if ((0, import_log.isRustError)(err)) {
      ...
      this.logEmitter.emit(
        "error",
        new import_PrismaClientRustError.PrismaClientRustError({
...
${import_chalk.default.dim("In case we're mistaken, please report this to us \u{1F64F}.")}`);
  ...
  getEngineEnvVars() {
    ...
    return {
      ...
      ...process.env,
      ...env,
      RUST_BACKTRACE: (_a = process.env.RUST_BACKTRACE) != null ? _a : "1",
...
You very likely have the wrong "binaryTarget" defined in the schema.prisma file.`
        ...
        this.child.on("close", (code, signal) => {
          ...
          if (code === null && signal === "SIGABRT" && this.child) {
            const error = new import_PrismaClientRustPanicError.PrismaClientRustPanicError(
  ...
  throwAsyncErrorIfExists(forceThrow = false) {
    ...
    if (this.lastRustError) {
      const err = new import_PrismaClientRustPanicError.PrismaClientRustPanicError(
        this.getErrorMessageWithLink((0, import_log.getMessage)(this.lastRustError)),
        this.clientVersion
      );
    ...
    if (this.lastErrorLog && (0, import_log.isRustErrorLog)(this.lastErrorLog)) {
      const err = new import_PrismaClientUnknownRequestError.PrismaClientUnknownRequestError(
        this.getErrorMessageWithLink((0, import_log.getMessage)(this.lastErrorLog)),
        this.clientVersion
      );
  ...
  transactionHttpErrorHandler(result) {
    ...
    throw new import_PrismaClientKnownRequestError.PrismaClientKnownRequestError(
      response.message,
      response.error_code,
      this.clientVersion,
      response.meta
