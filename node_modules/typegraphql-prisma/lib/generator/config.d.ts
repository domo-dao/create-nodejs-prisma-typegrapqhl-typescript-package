...
export declare type BaseKeys = keyof Pick<DMMF.ModelMapping, "modelName">;
...
export declare type SupportedMutations = keyof Pick<typeof DMMF.ModelAction, "createOne" | "createMany" | "deleteOne" | "updateOne" | "deleteMany" | "updateMany" | "upsertOne">;
