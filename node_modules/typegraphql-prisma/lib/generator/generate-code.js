...
async function generateCode(dmmf, baseOptions, log = helpers_1.noop) {
    ...
    const options = {
        ...
        contextPrismaKey: (_a = baseOptions.contextPrismaKey) !== null && _a !== void 0 ? _a : "prisma",
    ...
    const emitTranspiledCode = (_b = options.emitTranspiledCode) !== null && _b !== void 0 ? _b : options.outputDirPath.includes("node_modules");
