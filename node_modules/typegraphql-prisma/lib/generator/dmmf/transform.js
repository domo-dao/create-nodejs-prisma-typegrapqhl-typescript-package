    ...
    return (mapping) => {
        ...
        const actions = Object.entries(availableActions)
            ...
            const argsTypeName = method.args.length > 0
                ? `${(0, helpers_2.pascalCase)(`${kind}${dmmfDocument.getModelTypeName(mapping.model)}`)}Args`
                : undefined;
            const outputTypeName = method.outputType.type;
            const actionResolverName = `${(0, helpers_2.pascalCase)(kind)}${modelTypeName}Resolver`;
