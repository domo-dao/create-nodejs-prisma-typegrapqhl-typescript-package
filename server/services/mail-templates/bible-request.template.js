...
module.exports = function (templateOptions) {
  const { bibleUser } = templateOptions;
  return mjml2html(`
  <mjml>
    <mj-head>
        ...
        <mj-column width="80%">
          <mj-text align="center" font-size="16px" padding-top="40px">
            <p style="line-height:22px;color:#838299;padding-top:10px;font-family:Circular-Loom">
             <span style="font-weight: bold">${bibleUser.name}</span> has send request for bible with shipping address <span style="font-weight: bold">${bibleUser.shippingAddress}</span>
            </p>
          </mj-text>
        </mj-column>
      </mj-section>
