        ...
        <mj-column width="80%">
          <mj-text align="center" font-size="16px" padding-top="40px">
            <p style="line-height:22px;color:#838299;padding-top:10px;font-family:Circular-Loom">
             <span style="font-weight: bold">We have been experiencing difficulties communicating and pulling data from RDN. We are working with their support team to fix this as soon as possible. We apologize for any inconvinient.</span>
            </p>
          </mj-text>
        </mj-column>
      </mj-section>
